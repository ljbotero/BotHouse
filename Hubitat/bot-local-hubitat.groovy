...
def subscribeToDeviceEvents(newDevice, deviceInfo) {
  switch (deviceInfo.deviceType) {
    case "urn:schemas-upnp-org:device:botlocal:push-button": 
      ...
      return
    case "urn:schemas-upnp-org:device:botlocal:contact":
      ...
      return
    case "urn:schemas-upnp-org:device:botlocal:on-off-switch":
      ...
      return
    case "urn:schemas-upnp-org:device:botlocal:switch-relay":
...
def discoveryDeviceType() { return "urn:schemas-upnp-org:device:botlocal" }
def appName() { return "BotLocal" }
